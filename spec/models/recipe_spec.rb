...
RSpec.describe Recipe, type: :model do
  ...
  it 'should check presence of name' do 
    recipe1 = Recipe.create(name: 'recipe1', description: 'testing', preparation_time: 2, cooking_time: 3, user_id: @user.id)
  ...
  it 'should check cooking_time and preparation_time to be positive numbers' do 
    recipe1 = Recipe.create(name: 'recipe1', description: 'testing', preparation_time: 2, cooking_time: 3, user_id: @user.id)
    recipe2 = Recipe.create(name: 'recipe2', description: 'testing', preparation_time: -2, cooking_time: -3, user_id: @user.id)
