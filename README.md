...
**Blog App** is a full-stack website made with the ruby-on-rails framework where users view recipes posted by other users, upload recipes, keep track of personal inventory, automatically generate a shopping list for a particular recipe and more.
...
- **Users can keep track of personal inventories**
...
- Twitter: [twitter](https://twitter.com/MBilal_Pro)
- LinkedIn: [linkedin](https://www.linkedin.com/in/muhammad-bilal-liaquat-87863390/)

👤 **Hydaline**

- GitHub: [github](https://github.com/hydaline-code)
